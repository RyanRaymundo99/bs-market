    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader>
              <CardTitle className="text-white">Selected Order Details</CardTitle>
            </CardHeader>
            <CardContent>
              {selectedOrder ? (
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-400">External Order ID</p>
                    <p className="text-sm font-mono text-white">
                  ...
                  {selectedOrder.deposit && (
                    <div>
                      <p className="text-sm text-gray-400">Deposit External ID</p>
                      <p className="text-sm font-mono text-white">
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader>
            <CardTitle className="text-white">Quick Test Options</CardTitle>
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader>
            <CardTitle className="text-white">Webhook Payload</CardTitle>
            <p className="text-sm text-gray-400 mt-2">
          ...
          <CardContent>
            <textarea
              ...
              className="w-full h-64 p-4 bg-gray-800 border border-gray-700 rounded-lg text-white font-mono text-sm resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                {testResult.balanceUpdated !== undefined && (
                  <div>
                    <p className="text-sm text-gray-400">Balance Updated</p>
                ...
                {testResult.details && (
                  <div>
                    ...
                    <p className="text-sm text-gray-300">{testResult.details}</p>
                  </div>
                )}
              </div>
            </CardContent>
