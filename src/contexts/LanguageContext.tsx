...
const translations = {
  pt: {
    ...
    balanceChartSubtitle:
      "Saldo USDT ao longo do tempo — passe o cursor para ver cada dia",
    chartRange7d: "7D",
    chartRange30d: "30D",
    chartRange90d: "90D",
    chartRangeAll: "Tudo",
    chartChangePeriod: "no período",
    seeAll: "Ver todas",
    ...
    uploadAllDocuments: "Enviar todos os documentos",
    documentsSelected: "documento(s) selecionado(s). Ainda não enviados — clique abaixo para enviar.",
    pendingUploadBadge: "Aguardando envio",
    ...
    activityNotifications: "Atividade e notificações",
    pendingTransactions: "Transações pendentes",
    notifications: "Notificações",
    checkEverything: "Ver tudo",
    viewAll: "Ver todos",
    markAllAsRead: "Marcar todas como lidas",
    noPending: "Nenhuma transação pendente",
    noNotifications: "Nenhuma notificação",
    receiptReady: "Recibo disponível",
    viewReceipts: "Ver recibos e pendências",
    activityPage: "Ver tudo",
  },
  en: {
    // Navigation
    dashboard: "Dashboard",
    ...
    balanceChartSubtitle:
      "USDT balance over time — hover the chart to explore each day",
    chartRange7d: "7D",
    chartRange30d: "30D",
    chartRange90d: "90D",
    chartRangeAll: "All",
    chartChangePeriod: "in period",
    seeAll: "See all",
    ...
    documentsSelected: "document(s) selected. Not uploaded yet — click below to send.",
    ...
    receiptReady: "Receipt available",
    viewReceipts: "View receipts and pending",
    activityPage: "View all",
  },
};
